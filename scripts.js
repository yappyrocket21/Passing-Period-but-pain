const WELCOME_MESSAGE = "<h1>Welcome to hell</h1>";
const CREDITS_MESSAGE = "<h1>Credits</h1>Original game and programming help by Nicco Scanu, fork by yappyrocket21";
const DATA_MESSAGE = "<h1>Data Collection Notice</h1>what am i fucking facebook";
